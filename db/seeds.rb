...
auction11= Auction1.create({property_id: '1', puja:'0', fechanew: '5-07-2020', fechainicio: '11-12-2018'})
auction12= Auction1.create({property_id: '2', puja:'0', fechanew: '17-06-2020', fechainicio: '15-06-2019'})
auction13= Auction1.create({property_id: '3', puja:'0', fechanew: '4-07-2020', fechainicio: '4-08-2019'})
auction14= Auction1.create({property_id: '4', puja:'0', fechanew: '6-06-2021', fechainicio: '4-12-2019'})
auction15= Auction1.create({property_id: '5', puja:'0', fechanew: '7-07-2021', fechainicio: '4-05-2019'})
auction16= Auction1.create({property_id: '6', puja:'0', fechanew: '11-07-2020', fechainicio: '4-09-2019'})